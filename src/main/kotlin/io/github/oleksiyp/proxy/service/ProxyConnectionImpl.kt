...
import io.github.oleksiyp.netty.NettyClient
import io.github.oleksiyp.netty.NettyScope
...
class ProxyConnectionImpl(override val listenPort: Int,
    ...
    private fun log(msg: String) = log.append("${Date()}: $msg")
    ...
    private val server = NettyServer(listenPort) {
        pipeline.addCoroutineHandler<ByteBuf> {
